...
public class BuffSpinningAnimation extends BuffAnimation{

	/**
	 * 
	 */
	private static final long serialVersionUID = 7971366640720204927L;

	public BuffSpinningAnimation(String key) {
		super(key);
	}
				...
				if (!target.isNPC()) {
					timeline.getKeyFrames().addAll(
							...
							new KeyFrame(
									...
									new KeyValue (imageView.scaleXProperty(), 1.1),
									new KeyValue (imageView.scaleYProperty(), 1.1)));
					timeline.play();
