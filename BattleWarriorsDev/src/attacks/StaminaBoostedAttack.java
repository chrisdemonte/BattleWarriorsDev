...
public class StaminaBoostedAttack extends Move{
	...
	public StaminaBoostedAttack(String name, String description, int energyCost, int uses, int currentUses,
			...
			double staminaBonus, double accuracy, double avoidability, double crit, double penetration,
			boolean rangedAttack) {
